...
export default describe('Recipient', () => {
  ...
  describe('toJson', () => {
    it('should return a JSON string of the object with proper parameters', () => {
      ...
      expect(obj.recipient.id).to.equal(sample.id);
      expect(obj.recipient.firstName).to.equal(sample.firstName);
      expect(obj.recipient.lastName).to.equal(sample.lastName);
      expect(obj.recipient.email).to.equal(sample.email);
      expect(obj.recipient.options.locked).to.equal(sample.options.locked);
      expect(obj.recipient.options.bouncedEmail).to.equal(sample.options.bouncedEmail);
      expect(obj.recipient.options.verified).to.equal(sample.options.verified);
      expect(obj.recipient.options.contactMethods.length).to.equal(sample.options.contactMethods.length);
      expect(obj.recipient.options.contactMethods[0].id).to.equal(sample.options.contactMethods[0].id);
      expect(obj.recipient.options.contactMethods[0].destination).to.equal(sample.options.contactMethods[0].destination);
      expect(obj.recipient.options.contactMethods[0].destinationType).to.equal(sample.options.contactMethods[0].destinationType);
      expect(obj.recipient.options.contactMethods[0].verified).to.equal(sample.options.contactMethods[0].verified);
      expect(obj.recipient.options.contactMethods[0].createdAt).to.equal(sample.options.contactMethods[0].createdAt);
      expect(obj.recipient.options.contactMethods[0].updateAt).to.equal(sample.options.contactMethods[0].updateAt);
      expect(obj.recipient.options.contactMethods[1].id).to.equal(sample.options.contactMethods[1].id);
      expect(obj.recipient.options.contactMethods[1].destination).to.equal(sample.options.contactMethods[1].destination);
      expect(obj.recipient.options.contactMethods[1].destinationType).to.equal(sample.options.contactMethods[1].destinationType);
      expect(obj.recipient.options.contactMethods[1].verified).to.equal(sample.options.contactMethods[1].verified);
      expect(obj.recipient.options.contactMethods[1].createdAt).to.equal(sample.options.contactMethods[1].createdAt);
      expect(obj.recipient.options.contactMethods[1].updateAt).to.equal(sample.options.contactMethods[1].updateAt);
